...
const CartPage = () => {
  ...
  useEffect(() => {
    const fetchCartItems = async () => {
      try {
        const response = await fetch("https://sales-savvy-backend.onrender.com:9090/api/cart/items", {
  ...
  const handleRemoveItem = async (productId) => {
    try {
      const response = await fetch("https://sales-savvy-backend.onrender.com:9090/api/cart/delete", {
        method: "DELETE",
  ...
  const handleQuantityChange = async (productId, newQuantity) => {
    try {
      ...
      const response = await fetch("https://sales-savvy-backend.onrender.com:9090/api/cart/update", {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
  ...
  const handleCheckout = async () => {
    try {
      ...
      const response = await fetch("https://sales-savvy-backend.onrender.com:9090/api/payment/create", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
      ...
      const options = {
        key: "rzp_test_MQlbx4rzQ3u4WU", // Replace with your Razorpay Key ID
        ...
        handler: async function (response) {
          try {
            ...
            const verifyResponse = await fetch("https://sales-savvy-backend.onrender.com:9090/api/payment/verify", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              credentials: "include",
              body: JSON.stringify({
